---
name: daily-rashifal
description: Generate today's daily horoscope (rashifal) for a specific moon sign in the user's chosen language (Tamil, Telugu, Kannada, Malayalam, Hindi, or English). Use this skill when the user asks for "today's rashifal", "daily horoscope", "horoscope for today", "aaj ka rashifal", "indraya raasi palan", "today's prediction for [moon sign]", "rashifal in tamil/telugu/kannada/malayalam/hindi", or names a moon sign and asks about today. Short, action-oriented forecast under 150 words. For a full month-ahead reading use monthly-horoscope; for a personal birth chart reading use kundli-basic-report or kundli-detailed-report.
---
...
- **Language for the rashifal** — one of: English / தமிழ் (Tamil) / తెలుగు (Telugu) / ಕನ್ನಡ (Kannada) / മലയാളം (Malayalam) / हिन्दी (Hindi). See `references/LANGUAGES.md`.
...
If language is missing, ask FIRST: *"Which language for today's rashifal? English / தமிழ் / తెలుగు / ಕನ್ನಡ / മലയാളം / हिन्दी"*. If the person doesn't know their moon sign, ask for their DOB and time and infer it. If they ask for "all signs", produce one short paragraph per sign in order.
